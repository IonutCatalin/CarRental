...
const ManageCar = () => {
    ...
    const getData = async () => {
        ...
        const carWithMatchingLocations = {
            ...snapshot.data(),
            locations: list.filter((car) => snapshot.data().locations.includes(car.value))
        }

        setCar(carWithMatchingLocations);
    };
    ...
    return (
        <>
            {car && <div className="container mt-5 mb-md-4 py-5">
                <div className="row">
                    <div className="col-lg-8">
                        <div className="mb-4">
                            <h1 className="h2 text-light mb-0">Edit vehicle</h1>
                        ...
                        <section className="card card-light card-body border-0 shadow-sm p-4 mb-4" id="price">
                            ...
                            <div className="d-sm-flex mb-2 form_item">
                                ...
                                <input className="w-100 me-2 mb-2" type="number" name="price"
                                       id="sc-price" min="1" step="50" value={car.price} required=""
                                       onChange={onCarChange}/>
                            </div>
                        ...
                        <div className="d-sm-flex justify-content-between pt-2">
                            <div className={`custom_btn bg_default_red text-uppercase c-p ${isSubmitButtonDisabled() ? 'disabled' : ''}`} onClick={onCarEdit}>Save {loading && <LoaderComponent/>}</div>
                        </div>
                    </div>
